...
当前版本：**[v1.4.13](https://github.com/0-V-linuxdo/Bloom/releases/tag/v1.4.13)**（`userscript/Bloom.user.js`，`@version [20260902] v1.4.13`）。
...
| NoSidebarIdentity | 开 | 隐藏侧栏头像旁的显示名。可选：放大 Plus/Pro/Free，与头像高度对齐。纯 CSS。 |
