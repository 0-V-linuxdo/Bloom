...
当前版本：**[v1.4.62](https://github.com/0-V-linuxdo/Bloom/releases/tag/v1.4.62)**（`userscript/Bloom.latest.user.js`，`@version [20260920] v1.4.62`）。
...
- 纯 CSS 画在官方头像 `img` 和 `.truncate::before` 上，不往芯片插节点、不改 `img.src` / `.truncate` 文本
