...
- ChatStateFavicons owns `#bloom-chat-state-favicon` in `document.head` with a head-only competitor guard. Wait/badge/dot may keep the official icon; streaming / done / ready / error must replace it.
